...
PATH_TO_SENTEVAL = './Eval'
PATH_TO_DATA = './Eval/data'
...
class CLTrainer(Trainer):
    ...
    def evaluate(
        ...
        se = sent_data.engine.SE(params, batcher, prepare)
        task = self.model_args.task
        tasks = ['STSBenchmark', 'SICKRelatedness'] # 'STS12', 'STS13', 'STS14', 'STS15', 'STS16',
        # if task != 'original':
        #     tasks.append(task)
        ...
        metrics = {"eval_avg_sts": (stsb_spearman + sickr_spearman) / 2,
                  "eval_stsb_spearman": stsb_spearman, "eval_sickr_spearman": sickr_spearman, 
                   } 
        if eval_senteval_transfer or self.args.eval_transfer:
            avg_transfer = 0
