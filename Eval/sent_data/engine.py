...
from sent_data import utils
from sent_data.binary import CREval, MREval, MPQAEval, SUBJEval
from sent_data.snli import SNLIEval
from sent_data.trec import TRECEval
from sent_data.sick import SICKEntailmentEval, SICKEval
from sent_data.mrpc import MRPCEval
from sent_data.sts import STS12Eval, STS13Eval, STS14Eval, STS15Eval, STS16Eval, STSBenchmarkEval, SICKRelatednessEval, STSBenchmarkFinetune
from sent_data.sst import SSTEval
from sent_data.rank import ImageCaptionRetrievalEval
from sent_data.probing import *
...
class SE(object):
    ...
    def eval(self, name):
        ...
        if name == 'CR':
            ...
            self.evaluation = STSBenchmarkEval(tpath + '/STS/STSBenchmark-fix', seed=self.params.seed)
        elif name == 'STSBenchmark-finetune':
            self.evaluation = STSBenchmarkFinetune(tpath + '/STS/STSBenchmark', seed=self.params.seed)
